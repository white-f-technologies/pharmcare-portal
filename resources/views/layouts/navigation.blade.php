        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center space-x-6">
                ...
                <div class="hidden space-x-4 sm:-my-px sm:flex items-center">
                    ...
                    <!-- Direct POS Link -->
                    <a href="{{ route('sales.create') }}" class="inline-flex items-center px-3 py-1.5 bg-sky-500 hover:bg-sky-600 text-white rounded-lg text-xs font-bold transition shadow-sm gap-1.5">
