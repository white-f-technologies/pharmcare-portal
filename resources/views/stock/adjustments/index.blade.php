                                ...
                                <tr class="hover:bg-slate-50/50 transition">
                                    ...
                                    <td class="px-6 py-4 text-center whitespace-nowrap">
                                        @if($adj->movement_type === 'damage')
                                            <span class="px-2.5 py-1 bg-rose-100 text-rose-800 rounded-full font-extrabold text-[10px] uppercase">
                                                🚨 {{ __('Damage') }}
                                            </span>
                                        @elseif($adj->movement_type === 'return')
                                            <span class="px-2.5 py-1 bg-sky-100 text-sky-800 rounded-full font-extrabold text-[10px] uppercase">
                                                🔄 {{ __('Return') }}
                                            </span>
                                        @else
                                            <span class="px-2.5 py-1 bg-amber-100 text-amber-800 rounded-full font-extrabold text-[10px] uppercase">
                                                ✏️ {{ __('Adjustment') }}
                                            </span>
                                        @endif
                                    </td>
